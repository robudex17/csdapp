...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nvar APIADD = exports.APIADD = \"http://102.5.6.2/sbtph_csd_dev/api\";\n\n//# sourceURL=webpack:///./src/js/config.js?");
...
"use strict";
eval("\n\nvar _User = __webpack_require__(/*! ./models/User */ \"./src/js/models/User.js\");\n\nvar _User2 = _interopRequireDefault(_User);\n\nvar _userViews = __webpack_require__(/*! ./views/userViews */ \"./src/js/views/userViews.js\");\n\nvar userViews = _interopRequireWildcard(_userViews);\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nwindow.addEventListener('load', function (event) {\n    var user = new _User2.default(1);\n    user.checkIfLogin();\n    console.log(user.jwt);\n    if (user.jwt) {\n        window.location.href = \"#\";\n    } else {\n        userViews.clearBody();\n        userViews.loginpage();\n    }\n});\n\n// //User Controller\n// const user = new User();\n// user.checkIfLogin();\n// if(user.jwt){\n//     //render index front page(index.html/#)\n// }else{\n\n// }\n\n//# sourceURL=webpack:///./src/js/index.js?");
