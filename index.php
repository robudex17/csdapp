...
<html lang="en">
 ...
 <body class="bg-light" onload="getLoginUser()">
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
      <a class="navbar-brand mr-auto mr-lg-0 " href="#">CSD PHILIPPINES CALLS MONITORING</a><span style="margin:3px"><button  class="btn btn-primary btn-small btn-nav" ><i class="fa fa-phone" aria-hidden="true"  style="font-size:15px"></i></button></span>
