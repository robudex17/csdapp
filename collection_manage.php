       ...
       <div class="navbar-collapse collapse w-100 order-3 dual-collapse2">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                ...
                <input type="hidden" name="type" id="type" value="collectionAgent">
...
<main role="main" class="container" id="main">
        ...
        <div class="row justify-content-md-center pb-5">
            ...
            <div class="col-6">
               <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#myModalCollection" dataset-backdrop="static" dataset-keyboard="false" id="add_agent">ADD AGENT</button>
            </div>
              <div class="col">
