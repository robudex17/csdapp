...
<body class="bg-light" onload="voicemails()">
...
<div class="nav-scroller bg-blue shadow-sm">
      <nav class="nav nav-underline">
        ...
        <a class="nav-link mx-0 px-2 btn btn-primary btn-lg active" href="voicemails.php">VOICE-MAILS </a> 
