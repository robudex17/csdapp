...
function searchCalledNumberDetails() {
    ...
    xhttp.onreadystatechange = function() {
      if (this.readyState == 4 && this.status == 200) {
        var tbody = 'search_callednumber_details_tbody'

        searchCalledNumberDetailsTable(this.responseText,tbody);
        
      }
    };
   
      var apiquery = `api/csdoutbound/search_outbound_number_api.php?${querystring}`;
